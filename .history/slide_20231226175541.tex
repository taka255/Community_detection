...
\begin{frame}
  ...
  \end{itemize}
  Proof: Suppose there is an algorithm for weak reconstruction, which means that we can say ``there is a community'' or ``there is no community'' with probability better than random guess. \\
