...
\begin{frame}
  ...
  \begin{itemize}
      \item In computer science, we think worst-case instances for evaluating algorithms.
      \item However, the real world networks are not worst-case instances.
      \item In physics, we think \alert{typical instances} for evaluating models.
  \end{itemize}
\end{frame}
