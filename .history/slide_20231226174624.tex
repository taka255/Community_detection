...
\begin{frame}
  ...
  \end{itemize}
  We write $P \trianglelefteq Q$ for any $E$ such that $\lim_{n \to 0} Q(E) = 0$, $\lim_{n \to 0} P(E) = 0$.\\
  If $P \trianglelefteq Q$ and $Q \trianglelefteq P$, we say $P$ and $Q$ are \alert{contiguous}.
