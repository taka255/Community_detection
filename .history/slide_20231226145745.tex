...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item From an analogy of the phase transition in the Ising model, we can expect the success-to-failure phase transition in the community detection.
    \item Considering only the MLE is not enough to understand the properties of magnetism, which is 
  \end{itemize}
\end{frame}
