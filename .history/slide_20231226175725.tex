...
\begin{frame}
  ...
  \end{itemize}
  Intuitive Proof: Suppose there is an algorithm for weak reconstruction, which means that we can say ``there is a community'' to $G$ in SBM with high probability. \\
