...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \end{align}
      \item The probability of the system is given by the Boltzmann distribution
      \begin{align}
...
\begin{frame}
  ...
  \begin{align}
    ...
    & = \prod_{(i, j) \in E}  \qty( \frac{c_{in}}{n} \delta_{\sigma_i, \sigma_j} + \frac{c_{out}}{n} (1 - \delta_{\sigma_i, \sigma_j})) \\
    P(\sigma) \propto \exp( \frac{c_{in}}{T} \sum_{(i, j) \in E}  \delta_{\sigma_i, \sigma_j} + \frac{c_{out}}{T} \sum_{(i, j) \notin E}  \delta_{\sigma_i, \sigma_j}).
  \end{align}
