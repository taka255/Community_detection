...
\begin{frame}
  ...
  \end{itemize}
  We write $P \trianglelefteq Q$ if $\lim_{n \to 0} Q(E) = 0$ for any $E \in \mathcal{F}_P$ where $\mathcal{F}_P$ is the set of events that can be expressed by the adjacency matrix of $P$.
