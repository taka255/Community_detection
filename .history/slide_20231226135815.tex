...
\begin{frame}
  ...
  \begin{itemize}
    \item Exact reconstruction: Finding the planted assignment $\boldsymbol{\sigma}$ exactly up to 
    \item Reconstruction (weak recovery): Finding the planted assignment $\boldsymbol{\sigma}$ with a small error.
  \end{itemize}
