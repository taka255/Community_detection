...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Uniform fixed point attracts large fraction of the initial messages.
    \end{itemize}
    \item[(2)] accurate point $>$ uniform point
    \begin{itemize}
      \item Uniform fixed point is better than the accurate one.
      \item However, expotentially small fraction of the initial messages are attracted to the uniform fixed point.
    \end{itemize}
  \end{itemize}
