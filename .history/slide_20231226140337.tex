...
\begin{frame}
  ...
  \end{itemize}
  In this talk, we assume $c_in$ and $c_{out}$ are known and focus on the reconstruction and detection problems, which are strongly analogous to the clustering and outlier detection problems in machine learning.
