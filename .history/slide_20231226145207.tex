...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{figure/ising.jpeg}
  ...
  \end{itemize}
  When $J$ is large, the system is in the \alert{ferromagnetic phase} where the spins are aligned. When $J$ is small, the system is in the \alert{paramagnetic phase} where the spins are randomly distributed.
