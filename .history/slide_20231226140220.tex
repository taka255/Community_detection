...
\begin{frame}
  ...
  \begin{itemize}
    \item Exact reconstruction: Finding the planted assignment exactly up to a global permutation.
    \item Reconstruction (weak recovery): Finding the planted assignment whose accuracy is better than random guess ($1/q$).
    \item Detection: Hypothesis testing whether $G$ is generated from SBM or Eronds-Renyi model.
  \end{itemize}
  In this talk, we assume $c_in$ and $c_{out}$ are known and focus on the reconstruction and detection problems.
