...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item From an analogy of the phase transition in the Ising model, we can expect the success-to-failure phase transition in the community detection problem.
  \end{itemize}
\end{frame}
