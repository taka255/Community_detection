...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.4\linewidth]{figure/eign.png}
      \caption{The distribution of eigenvalues of $B$}
    \end{figure}
  \end{itemize}
...
\begin{block}{Kesten-Stigum threshold}
  If $c > \frac{c_{in} - c_{out}}{c_{in}}$, BP converges to the trivial fixed point.
\end{block}
